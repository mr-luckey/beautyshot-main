import 'package:beautyshot/Views/client_screens/confirmed_project_details.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

import 'constants.dart';

class ConfirmedProjectItem extends StatelessWidget {
  ...
  const ConfirmedProjectItem({Key? key,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){
        Get.to(()=>ConfirmedProjectDetails(projectId: projectId, projectName: projectName, projectBudget: projectBudget, projectLocation: projectLocation, projectLatitude: projectLatitude, projectLongitude: projectLongitude, projectTillDate: projectTillDate, projectFromDate: projectFromDate, projectCreatedBy: projectCreatedBy,firstOption: [firstOption],secondOption: [secondOption],confirmed:[confirmed]));
      },
      child: Container(
