...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  CollectionReference users = FirebaseFirestore.instance.collection('models');
...
// Reauthenticate
  ...
  deleteUsers() async {
    Get.back();
    Get.defaultDialog(title: "Deleting User",content:const LoadingWidget() ,titleStyle: KFontStyle.kTextStyle14Black );
    try {
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text("Delete Account",style: KFontStyle.kTextStyle16BlackRegular,),
                            ),
                          ],
                        ),
                      ),),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(left: 30,right: 30,top: 15,bottom: 15),
                              child: Text("Back",style: KFontStyle.kTextStyle16BlackRegular,),
                            ),
                          ],
                        ),
                      ),),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Text(Strings.settings,style: KFontStyle.newYorkSemiBold22,),
        ),
        toolbarHeight: 80,
        centerTitle: true,
