...
class JobProposalsScreen extends StatefulWidget {
  const JobProposalsScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Text(Strings.jobProposals,style: KFontStyle.newYorkSemiBold22,),
        ),
        toolbarHeight: 80,
        centerTitle: true,
        ...
        child: Center(
          child: StreamBuilder(
              stream: FirebaseFirestore.instance
                  ...
                  .where('modelIds', arrayContains: userId).where('status',isEqualTo: 'confirmed')
                  .snapshots(),
              builder: (context,
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (BuildContext context,
                        ...
                        return ModelProposalItem(
                          ...
                          pdfLink:  streamSnapshot.data?.docs[index]['pdfLink'],
                          amount: streamSnapshot.data?.docs[index]['amount'],
                          notes: streamSnapshot.data?.docs[index]['notes'],
                          jobTitle: streamSnapshot.data?.docs[index]['jobTitle'],
                          contractId: streamSnapshot.data?.docs[index]['contractId'],
